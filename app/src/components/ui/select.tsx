 ...
 * Lightweight alternative to @radix-ui/react-select for the MVP — has
 * native mobile pickers, no extra dependencies, accessible by default.
 */
const Select = React.forwardRef<HTMLSelectElement, React.SelectHTMLAttributes<HTMLSelectElement>>(
  ({ className, children, ...props }, ref) => (
    <div className="relative">
      ...
      <ChevronDown className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-secondary-500" />
    </div>
  )
);
