...
-- Adjusted per user feedback (2026-05-07): drop ПЖД, simplify pump/fire/filter wording.
...
values ('МЗВ', 'pre_shift', '[
  ...
  {"id":"leaks_visual","name_ru":"Визуальный осмотр на наличие течи","severity":"critical"},
  {"id":"fire_system","name_ru":"Проверка системы пожаротушения","severity":"critical"},
  ...
  {"id":"pump_visual","name_ru":"Визуальный осмотр насосной группы","severity":"critical"},
...
values ('МСЗ', 'pre_shift', '[
  ...
  {"id":"lights","name_ru":"Освещение, сигналы, проблесковый маячок","severity":"normal"},
  {"id":"brakes","name_ru":"Тормозная система","severity":"critical"},
  {"id":"an_level","name_ru":"Уровень аммиачной селитры (AN) в бункере","severity":"normal"},
...
-- ============================================================
-- МЗУ (Emulsion + AN, no diesel) — pre-shift
-- ============================================================
insert into checklist_templates (machine_type, kind, items)
